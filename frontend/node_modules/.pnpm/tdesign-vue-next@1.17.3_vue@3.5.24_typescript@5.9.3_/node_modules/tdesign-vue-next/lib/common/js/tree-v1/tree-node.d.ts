...
import type { TreeNodeState, TreeNodeValue, TypeIdMap, TypeSettingOptions, TypeTreeItem, TypeTreeNodeData, TypeTreeNodeModel } from './types';
...
export declare class TreeNode {
    ...
    setDisabled(disabled: null | boolean): void;
    update(): void;
