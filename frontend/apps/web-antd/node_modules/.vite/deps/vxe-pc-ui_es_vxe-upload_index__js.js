import {
  button_default
} from "./chunk-5ZLQ3E4H.js";
import "./chunk-I3F7TZTJ.js";
import {
  getEventTargetNode,
  getTpImg,
  initTpImg,
  toCssUnit
} from "./chunk-CE7P6NZ2.js";
import "./chunk-N4KHLO2J.js";
import {
  getSlotVNs
} from "./chunk-LEGYZ4U7.js";
import {
  defineVxeComponent,
  dynamicApp,
  errLog,
  warnLog
} from "./chunk-ANPO3F5F.js";
import {
  VxeUI,
  createEvent,
  getConfig,
...
// ../../node_modules/.pnpm/vxe-pc-ui@4.10.27_vue@3.5.24_typescript@5.9.3_/node_modules/vxe-pc-ui/es/upload/src/upload.js
var import_xe_utils2 = __toESM(require_xe_utils());

// ../../node_modules/.pnpm/vxe-pc-ui@4.10.27_vue@3.5.24_typescript@5.9.3_/node_modules/vxe-pc-ui/es/upload/src/util.js
...
var upload_default = defineVxeComponent({
  ...
  setup(props, context) {
    ...
    const internalData = {
      moreId: import_xe_utils2.default.uniqueId("upload"),
        ...
        VxeUI.modal.open({
          ...
          slots: {
            default() {
              ...
              }] }, ons), moreContSlot ? getSlotVNs(moreContSlot({ options: fileList })) : [
    ...
    const renderFileItemList = (currList, isMoreView) => {
      ...
      return currList.map((item, index) => {
        ...
        return h("div", Object.assign({ key: dragSort ? fileKey : index, class: ["vxe-upload--file-item", {
          ...
          "is--error": isError
        }], fileid: fileKey, draggable: dragSort ? true : null }, ons), optionSlot ? getSlotVNs(optionSlot({ option: item, isMoreView, options: fileList })) : [
          h("div", {
          ...
          }, actionSlot ? getSlotVNs(actionSlot({ option: item, isMoreView, options: fileList, readonly: formReadonly })) : [
            cornerSlot ? h("div", {
              class: "vxe-upload--file-item-action"
            }, getSlotVNs(cornerSlot({ option: item, isMoreView, options: fileList, readonly: formReadonly }))) : renderEmptyElement($xeUpload),
    ...
    const renderFileAction = (isMoreView) => {
      ...
      return h("div", {
        ...
        autoHiddenButton && overCount ? renderEmptyElement($xeUpload) : h("div", {
          ...
          onClick: clickEvent
        }, defaultSlot ? getSlotVNs(defaultSlot({ isMoreView, options: fileList, $upload: $xeUpload })) : [
          h(button_default, {
        ...
        }, tipSlot ? getSlotVNs(tipSlot({ isMoreView, options: fileList, $upload: $xeUpload })) : `${defTipText}`) : renderEmptyElement($xeUpload)
      ]);
    };
    const renderAllMode = () => {
      ...
      return h("div", {
        ...
        currList.length || showMoreButton && isHorizontal ? h("div", {
          ...
          }, moreBtnSlot ? getSlotVNs(moreBtnSlot({ options: fileList })) : [
            h(button_default, {
              mode: "text",
...
// ../../node_modules/.pnpm/vxe-pc-ui@4.10.27_vue@3.5.24_typescript@5.9.3_/node_modules/vxe-pc-ui/es/upload/index.js
...
// ../../node_modules/.pnpm/vxe-pc-ui@4.10.27_vue@3.5.24_typescript@5.9.3_/node_modules/vxe-pc-ui/es/vxe-upload/index.js
