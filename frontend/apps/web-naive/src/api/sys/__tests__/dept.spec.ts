...
describe('Department API', () => {
  it('should call getDeptList with correct parameters', async () => {
    ...
    expect(requestClient.get).toHaveBeenCalledWith('/sys-dept/list', {
  ...
  it('should call createDept with correct parameters', async () => {
    ...
    expect(requestClient.post).toHaveBeenCalledWith('/sys-dept', data);
  });
  ...
  it('should call updateDept with correct parameters', async () => {
    ...
    expect(requestClient.put).toHaveBeenCalledWith('/sys-dept/123', data);
  });

  it('should call deleteDept with correct parameters', async () => {
    const id = '123';
    await deleteDept(id);
    expect(requestClient.delete).toHaveBeenCalledWith('/sys-dept/123');
  });

  it('should call getDept with correct parameters', async () => {
    const id = '123';
    await getDept(id);
    expect(requestClient.get).toHaveBeenCalledWith('/sys-dept/123');
  });
});
